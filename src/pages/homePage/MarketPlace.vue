<template>
    ...
    <section class="overflow-hidden bg-blue-200 sm:grid sm:grid-cols-2 sm:items-center" id="market">
        <img
        alt=""
      ...
      <div class="p-8 md:p-12 lg:px-16 lg:py-24">
        <div class="mx-auto max-w-xl text-center ltr:sm:text-left rtl:sm:text-right">
          <h2 class="text-center sm:text-left text-2xl font-bold text-gray-900 md:text-3xl text-left">
            Market Place
          </h2>
    
          <p class="text-center sm:text-left  text-gray-500 md:mt-4 md:block text-left">
