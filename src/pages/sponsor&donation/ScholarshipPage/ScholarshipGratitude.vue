  ...
  <div class="flex flex-col w-fit h-auto m-5">
    ...
    <div class="m-auto w-[23.5rem] h-auto py-3 ">
      ...
      <div class="text-gray-500 text-sm">
        <p>Thank you for participating in this program. Your generousity is highly appreciated. </p>
      <p>We will contact you within a week for future discussion and procedures</p>
      </div>
    </div>
